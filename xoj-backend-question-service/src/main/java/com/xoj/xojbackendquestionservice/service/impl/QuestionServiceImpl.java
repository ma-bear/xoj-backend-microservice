...
import com.xoj.xojbackendmodel.model.dto.Question.QuestionQueryRequest;
...
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question>
    ...
    public QueryWrapper<Question> getQueryWrapper(QuestionQueryRequest questionQueryRequest) {
        ...
        queryWrapper.like(StringUtils.isNotBlank(content), "title", content);
        queryWrapper.like(StringUtils.isNotBlank(content), "content", answer);
